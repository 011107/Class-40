...
obstacles=new Group();
    var obstaclesPositions = [
      ...
      { x: width / 2 - 150, y: height - 4300, image: o1 },
      { x: width / 2 + 250, y: height - 4800, image: o2 },
      { x: width / 2, y: height - 5300, image: o1 },
      { x: width / 2 - 180, y: height - 5500, image: o2 }
    ...
    this.addSprites(obstacles, obstaclesPositions.length, o1, 0.04,obstaclesPositions);
  }
